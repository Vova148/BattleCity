...
void Tank::setOrientation(const EOrientation eOrientation)
{
	...
	case Tank::EOrientation::Top:
		m_pSprite->setState(std::basic_string("tankTopState"));
		m_moveOffset.x = 0.f;
		m_moveOffset.y = 1.f;
		break;
	case Tank::EOrientation::Bottom:
		m_pSprite->setState(std::basic_string("tankBottomState"));
		m_moveOffset.x = 0.f;
		m_moveOffset.y = -1.f;
		break;
	case Tank::EOrientation::Left:
		m_pSprite->setState(std::basic_string("tankLeftState"));
		m_moveOffset.x = -1.f;
		m_moveOffset.y = 0.f;
		break;
	case Tank::EOrientation::Right:
		m_pSprite->setState(std::basic_string("tankRightState"));
		m_moveOffset.x = 1.f;
		m_moveOffset.y = 0.f;
		break;
	default:
